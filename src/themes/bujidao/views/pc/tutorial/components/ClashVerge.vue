  ...
  <ol>
    ...
    <li>
      ...
      <div class="flex-row-wrap">
        <div>
          <p>3.1、打开软件后，点击订阅</p>
          <img src="@bujidao/assets/img/tutorial/windows/ClashVerge/add-sub-1.webp" />
        </div>
        <div>
          <p>3.2、将上面复制下来的URL，粘贴进，并点击导入</p>
          <img src="@bujidao/assets/img/tutorial/windows/ClashVerge/add-sub-2.webp" />
        </div>
        <div>
          <p>3.3、切换为岛岛的配置文件</p>
          <img src="@bujidao/assets/img/tutorial/windows/ClashVerge/select-bujidao.webp" />
        </div>
      </div>
    </li>
    <li>
      ...
      <div class="flex-row-wrap">
        <div>
          <img src="@bujidao/assets/img/tutorial/windows/ClashVerge/rule.webp" />
        </div>
      </div>
    </li>
    <li>
      ...
      <div class="flex-row-wrap">
        <div>
          <img src="@bujidao/assets/img/tutorial/windows/ClashVerge/proxy-tun.webp" />
        </div>
      </div>
    </li>
  </ol>
